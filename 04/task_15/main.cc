...
template < typename T, typename L, bool E = empty_v < L > > struct Consist {};

template < typename T, typename L > struct Consist < T, L, true  > { 
    static constexpr bool value = false; 
};

template < typename T, typename L > struct Consist < T, L, false >
{
private:
...
public:
    ...
    static constexpr bool value = (std::is_same_v < T, contender >) | (Consist <T, pop_front < L >>::value) ;

};

template < typename T, typename L >  
constexpr bool consist = Consist < T, L >::value;
...
//  ================================================================================================
    ...
    using list_4 = List <int, bool, char > ;

    static_assert(consist< int, list_3 >);
    static_assert(consist< bool, list_3 >);
    static_assert(consist< char, list_3 >);
    static_assert(!consist< double, list_3 >);
